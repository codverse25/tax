...
// Proxy ke /api/feedback — calls Apps Script server-side (no CORS)
...
function FeedbackCard({ feedback, index, inView }: { feedback: Feedback; index: number; inView: boolean }) {
    return (
        <div
        ...
        >
            <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-foreground">{feedback.nama}</span>
                </div>
...
const FeedbackSection = () => {
    ...
    // Fetch approved feedback once when section enters view
    useEffect(() => {
    ...
    return (
        <section id="feedback" className="py-16 sm:py-24 px-4 sm:px-6 border-t border-border">
                    ...
                    >
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-1.5">
                                <label htmlFor="feedback-nama" className="text-xs font-medium text-muted-foreground uppercase tracking-wider">
                                    Nama <span className="text-muted-foreground/50 normal-case font-normal">(opsional)</span>
                                </label>
                                <input
                                    id="feedback-nama"
                                    type="text"
                            ...
                            <div className="space-y-1.5">
                                <label htmlFor="feedback-pesan" className="text-xs font-medium text-muted-foreground uppercase tracking-wider">
                    ...
                    <div className="space-y-4">
                        {fetchError ? (
                            ...
                            >
                                ...
                                <p className="text-sm text-muted-foreground">Belum ada feedback yang tampil.</p>
